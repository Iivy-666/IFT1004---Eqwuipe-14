...
class Plateau:
    ...
    def case_est_vide(self, position_code):
        ...
        """
        # TODO: À compléter                     # OK
        ma_pos = self.decode_position(position_code)            # retourne Tuple
        x = ma_pos[0]
        y = ma_pos[1]
        return self.cases[x][y].est_vide()
    ...
    def est_vide(self):
        ...
        for i in range(self.dimension):
            for j in range(self.dimension):
                ma_case = self.cases[i][j]
                if ma_case.est_vide() is False:
                    return False
        return True
    ...
    def ajouter_jeton(self, jeton, position_code):
        ...
        """
        # TODO: À compléter                                 # OK
        ma_pos = self.decode_position(position_code)        # ma_pos == tuple
        if self.cases[ma_pos[0]][ma_pos[1]].est_vide():
            self.cases[ma_pos[0]][ma_pos[1]] = jeton            # Refactor avec fonction placer_jeton(jeton)
            return True
        return False
    ...
    def retirer_jeton(self, position_code):
        ...
        # TODO: À compléter                                    # OK
        ma_pos = self.decode_position(position_code)        # ma_pos == tuple
        return self.cases[ma_pos[0]][ma_pos[1]].retirer_jeton()

#        if self.cases[ma_pos[0]][ma_pos[1]].est_vide() is False:
#            self.cases[ma_pos[0]][ma_pos[1]].retirer_jeton()
#            return True
#        return False
