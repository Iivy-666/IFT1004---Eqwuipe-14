...
class Plateau:
    ...
    def case_est_vide(self, position_code):
        ...
        ma_pos = self.decode_position(position_code)            # retourne un tuple
        x = ma_pos[0]           #ligne
        y = ma_pos[1]           #colonne
    ...
    def est_vide(self):
        ...
        for i in range(self.dimension):         # pour chaque ligne
            for j in range(self.dimension):     # pour chaque colonne
    ...
    def ajouter_jeton(self, jeton, position_code):
        ...
        ma_pos = self.decode_position(position_code)
        if self.cases[ma_pos[0]][ma_pos[1]].est_vide():
            self.cases[ma_pos[0]][ma_pos[1]].jeton_occupant = jeton
            return True
        return False
